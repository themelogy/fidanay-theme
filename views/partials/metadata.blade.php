...
{!! Theme::style("vendor/rs-plugin/css/settings.min.css") !!}
{!! Theme::style("css/revo-slider/custom.min.css") !!}
<!-- IE warning CSS -->
...
<!--[if lte IE 7]>
{!! Theme::script('js/lte-ie7.js') !!}
<![endif]-->
{!! Theme::style('css/style.css') !!}
{!! Theme::style('css/layout/wide.css') !!}
{!! Theme::style('css/colors/blue1.css') !!}
{!! Theme::style('css/custom.min.css') !!}

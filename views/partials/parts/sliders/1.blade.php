                ...
                <div class="tp-banner">
                    ...
                    @if(count($slide->sliders)>0)
                        @foreach($slide->sliders as $slider)
                            <!-- SLIDE 1 -->
                                <li data-transition="zoomin" data-slotamount="7" data-masterspeed="500" data-thumb="{{ $slider->present()->firstImage(360,280,'fit',50) }}" data-saveperformance="off" data-title="{{ $slider->title }}">

                                    <!-- MAIN IMAGE -->
                                    <img src="{!! Theme::url('images/revo-slider/dummy.png') !!}"
                                         alt="{{ $slider->title }}"
                                         data-lazyload="{{ $slider->present()->firstImage(1280,650,'fit',50) }}"
